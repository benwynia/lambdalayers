...
def main():
    ...
    print("-"*55)
    packageNameOrRequirementsFile = input("Please Enter Package Name or a path to requirements.txt file for which you want to create a AWS Layers ie requests : ")
    print("-"*55)
    ...
    try:
        ...
        if os.path.isfile(packageNameOrRequirementsFile):
            with open(packageNameOrRequirementsFile, "r") as f:
                packages = f.read().splitlines()
        else:
            packages = [packageNameOrRequirementsFile]
